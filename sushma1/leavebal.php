...
$con = mysqli_connect('localhost','root','') or die(mysqli_error());
 ...
 $query="select Typeofleave,Noofdays,Status from leavetable where Name='".$_SESSION['name']."'";
...
$ep='';
$mvp='';
$qu=mysqli_query($con,"select Gender from info1 where Name='".$_SESSION['name']."'");
...
echo ",YOUR LEAVE BALANCE IS</h2></b2></i></center>";
echo "<br>";
 echo "<center><table border='1' cellpadding='12'>";
echo "<tbody>";
 echo "<tr>";
