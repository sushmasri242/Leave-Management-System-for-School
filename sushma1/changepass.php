...
if(isset($_POST['ChangePassword']))
{
 ...
 {
   $query=mysqli_query($con,"select * from login where username='".$_SESSION['name']."'") or die(mysqli_error());
 ...
 { 
   ...
   {
    $query=mysqli_query($con,"update login set password='".$npass."' where username='".$_SESSION['name']."'");
