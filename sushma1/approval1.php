...
mysqli_select_db($con,'anu') or die(mysqli_error());
 ...
 { 
	$id=$_GET['del'];
	$query=mysqli_query($con,"select * from leavetable1 where Name='".$id."'") or die("failure");
	echo "<center>";
 ...
 while($res=mysqli_fetch_array($query,MYSQLI_ASSOC))
 {
	...
	echo "<td>";
	echo "<a href='approve1.php?app=$res[Leaveid]'>approve</a>";
	echo "</td><td>";
	
	echo "<a href='rej1.php?rej=$res[Leaveid]'>reject</a>";
	echo "</td>";
