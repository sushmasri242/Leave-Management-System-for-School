...
if(isset($_POST['ChangePassword']))
{
 ...
 {
   $query=mysqli_query($con,"select * from adminlog where username='".$_SESSION['name']."'") or die(mysqli_error());
 ...
 { 
   ...
   {
    $query=mysqli_query($con,"update adminlog set password='".$npass."' where username='".$_SESSION['name']."'");
